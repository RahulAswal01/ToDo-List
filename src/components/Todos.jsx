...
const Todos = () => {
  ...
  return (
    <div>
      <div>
        {!todoApiData || todoApiData.length === 0 ? (
          <div className="invit_temp">
            <img
              src="\img\inviting template.png"
              alt="start making your Todo X"
              className="image"
            />
          </div>
        ) : (
                    ...
                    onClick={() => {
                      if (
                        ...
                        if (
                          ...
                          fetch(
                            "http://127.0.0.1:8000/completed_task_archived",
                            {
                              method: "POST",
                              headers: {
                                "Content-Type": "application/json",
                          ...
                          <UnarchiveOutlinedIcon
                            ...
                            onClick={() => {
                              if (
                                ...
                                fetch(
                                  "http://127.0.0.1:8000/archived_task_all",
                                  {
                                    method: "POST",
                                    headers: {
                                      "Content-Type": "application/json",
